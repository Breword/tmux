...
**Download [tmux 2.9 here](https://github.com/tmux/tmux/releases/download/2.9/tmux-2.9.tar.gz)** ([changes in this version](https://raw.githubusercontent.com/tmux/tmux/2.8/CHANGES)).
