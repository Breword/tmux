...
**Download [tmux 2.5 here](https://github.com/tmux/tmux/releases/download/2.5/tmux-2.5.tar.gz)** ([changes in this version](https://raw.githubusercontent.com/tmux/tmux/2.5/CHANGES)).
