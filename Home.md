...
**Download [tmux 2.6 here](https://github.com/tmux/tmux/releases/download/2.6/tmux-2.6.tar.gz)** ([changes in this version](https://raw.githubusercontent.com/tmux/tmux/2.6/CHANGES)).
